<div class="voice">
    ...
    <div class="btns"  id="btn-learn-next" style="margin-top:35px;background: #ff8b1e;border: 1px solid #ff3c00;width: 100%;text-align:center;color:#fff;padding:0;display: none">Go</div>
</div>