...
function InitLearnPage(position, lastposition, isfirst) {
    //try {
    //    var elments = document.getElementsByTagName("audio"); //.pause();
    ...
    switch (position) {
        ...
        case 2:
            ...
            if (((word.Spoken == 1 || word.Writen == 1 ) && lastposition == 3 && isfirst == 1) || ((word.Spoken == 1 || word.Writen == 1) && lastposition == 1 && isfirst == 1)) {
                ...
                kong += "<input type=\"text\" data-count=\"" + word.Syllables.length + "\"> <i class=\"back-del\" style=\"display:none\"></i><span class=\"none\" id=\"errorshow\"><img src=\"/egword/build/img/cry.png\" alt=\"\" class=\"ml30\" ><span class=\"error\">正确拼写:<span>" + word.Word + "</span></span></span><span class=\"none\" id=\"rightshow\"><img src=\"/egword/build/img/smail.png\" alt=\"\" class=\"ml30\"><span class=\"success\">正确</span></span>";
        ...
        case 3:
            ...
            $("#learn").children(".voice").children(".pronunce").html(wordTypeHtml+"<span id=\"biaohong\">" + wordStr + "</span>" + "<img src=\"/egword/build/img/horn.png\" data-id=\"" + word.WordId + "\" alt=\"\" class=\"horn\"><audio id=\"myaudio" + word.WordId + "\" src=\"" + word.Audio + "\" controls=\"controls\" hidden=\"true\" >");
